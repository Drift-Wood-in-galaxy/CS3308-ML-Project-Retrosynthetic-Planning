...
class RSPlanner:
    def __init__(self,
                 ...
                 mlp_templates=dirpath+'/one_step_model/my_model/Template_one_step.dat.npy',
                 mlp_model_dump=dirpath+'/one_step_model/my_mode/MLP_parameter_one_step.pkl',
                 save_folder=dirpath+'/saved_models',
                 value_model='my_model/MLP_parameter_mole.pkl',
                 fp_dim=2048,
                 viz=False,
                 viz_dir='viz'):
