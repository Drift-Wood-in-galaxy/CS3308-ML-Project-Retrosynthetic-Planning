...
parser.add_argument('--mlp_model_dump',
                    default='one_step_model/my_mode/MLP_parameter_one_step.pkl')
parser.add_argument('--mlp_templates',
                    default='one_step_model/my_model/Template_one_step.dat.npy')
...
parser.add_argument('--value_model', default='my_model/MLP_parameter_mole.pkl')
